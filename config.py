...
class GameConfig(BaseModel):
    ...
    default_players: List[str] = Field(default_factory=lambda: [
        "Prashant", "Bob", "Charlie", "Diana", "Eve", "Frank", "Grace",
    ...
    openai_api_key: str = Field(
        default_factory=lambda: os.getenv("OPENAI_API_KEY", "default_key"))
    ...
    def get_role_distribution(self) -> Dict[str, int]:
        ...
        mafia_count = max(
            self.min_mafia_count,
            min(self.max_mafia_count, int(total_players * self.mafia_ratio)))
